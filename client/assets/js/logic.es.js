...
`
        ...
        const greaterTwo = `
        <div class="col-md-12">
        <h6 class="card-text text-danger"> ${dates.length}día seleccionado. Seleccione al menos 2 días </h6>
     </div>
        `
        ...
        <br/>
            <br/>
                <div class="col-md-12">
                   <p class="card-text"> ${dates.length}días Seleccionado. Por favor, sienta el formulario para reservar. El valor total a pagar será <b class="text-danger">${currency(totalPrice).format()}</b>  </p>
                </div>`
