...
`
        ...
        const greaterTwo = `
        <div class="col-md-12">
        <h6 class="card-text text-danger"> ${dates.length} jour Sélectionné. Veuillez sélectionner au moins 2 jours </h6>
     </div>
        `
        ...
        <br/>
            <br/>
                <div class="col-md-12">
                   <p class="card-text"> ${dates.length} jours sélectionnés. Veuillez sentir le formulaire pour réserver. La valeur totale à payer sera <b class="text-danger">${currency(totalPrice).format()}</b>  </p>
                </div>`
