...
`
        ...
        const greaterTwo = `
        <div class="col-md-12">
        <h6 class="card-text text-danger"> ${dates.length} day Selected. Please Select at least 2 days </h6>
     </div>
        `
        ...
        <br/>
            <br/>
                <div class="col-md-12">
                   <p class="card-text"> ${dates.length} days Selected. Please feel the form to book. Total value to pay will be <b class="text-danger">${currency(totalPrice).format()}</b>  </p>
                </div>`
