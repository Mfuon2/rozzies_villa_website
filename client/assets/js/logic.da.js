...
`
        ...
        const greaterTwo = `
        <div class="col-md-12">
        <h6 class="card-text text-danger"> ${dates.length} dag valgt. Vælg venligst mindst 2 dage </h6>
     </div>
        `
        ...
        <br/>
            <br/>
                <div class="col-md-12">
                   <p class="card-text"> ${dates.length} dage valgt. Føl venligst formularen for at reservere. Samlet værdi at betale vil være<b class="text-danger">${currency(totalPrice).format()}</b>  </p>
                </div>`
